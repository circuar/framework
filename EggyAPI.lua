...
---@param _show_damage_tips boolean? 是否显示跳字
function GameAPI.apply_damage(_dst, _dmg, _src, _show_damage_tips) end
...
---获取滚动冷却时间
---@return Fixed 定点数
function RollComp.get_roll_cd() end

---设置滚动冷却时间
---@param _cd_time Fixed 时间
function RollComp.set_roll_cd(_cd_time) end
...
---获取飞扑冷却时间
---@return Fixed 定点数
function RushComp.get_rush_cd() end

---设置飞扑冷却时间
---@param _cd_time Fixed 时间
function RushComp.set_rush_cd(_cd_time) end
